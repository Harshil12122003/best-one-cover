...
const stockController = require('../../controller/StockController/stockController');
...
module.exports.getStocks = async (req, res) => {
    try {
        const response = await stockController.getStocks(req);
        if (!response.status) {
...
module.exports.getSingleStock = async (req, res) => {
    try {
        const response = await stockController.getSingleStock(req.params.id);
        if (!response.status) {
            const result = error(response.error, response.code ? response.code : 500);
            return res.status(response.code ? response.code : 500).json({
                status: response.code ? response.code : 500,
...
module.exports.createStock = async (req, res) => {
    try {
        const response = await stockController.createStock(req.body);
        if (!response.status) {
            const result = error(response.error, response.code ? response.code : 500);
            return res.status(response.code ? response.code : 500).json({
                status: response.code ? response.code : 500,
...
module.exports.updateStock = async (req, res) => {
    try {
        const response = await stockController.updateStock(req.params.id,req.body);
        if (!response.status) {
            const result = error(response.error, response.code ? response.code : 500);
            return res.status(response.code ? response.code : 500).json({
                status: response.code ? response.code : 500,
...
module.exports.deleteStock = async (req, res) => {
    try {
        const response = await stockController.deleteStock(req.params.id);
        if (!response.status) {
            const result = error(response.error, response.code ? response.code : 500);
            return res.status(response.code ? response.code : 500).json({
                status: response.code ? response.code : 500,
