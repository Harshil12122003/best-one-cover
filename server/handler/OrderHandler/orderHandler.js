...
module.exports.getOrders = async (req, res) => {
    try {
        const response = await orderController.getOrders(req);
        if (!response.status) {
...
module.exports.getMyOrders = async (req, res) => {
    try {
        const response = await orderController.getMyOrders(req.user);
        if (!response.status) {
            const result = error(response.error, response.code ? response.code : 500);
            return res.status(response.code ? response.code : 500).json({
                status: response.code ? response.code : 500,
...
module.exports.createOrder = async (req, res) => {
    try {
        ...
        const response = await orderController.createOrder(req.user.id, req.body);
        if (!response.status) {
            const result = error(response.error, response.code ? response.code : 500);
            return res.status(response.code ? response.code : 500).json({
                status: response.code ? response.code : 500,
...
module.exports.updateOrder = async (req, res) => {
    try {
        const response = await orderController.updateOrder(req.params.id,req.body);
        if (!response.status) {
            const result = error(response.error, response.code ? response.code : 500);
            return res.status(response.code ? response.code : 500).json({
                status: response.code ? response.code : 500,
...
module.exports.getSalesReport = async (req, res) => {
    try {
        const response = await orderController.getSalesReport(req);
        if (!response.status) {
            const result = error(response.error, response.code ? response.code : 500);
            return res.status(response.code ? response.code : 500).json({
                status: response.code ? response.code : 500,
...
module.exports.getProfitReport = async (req, res) => {
    try {
        const response = await orderController.getProfitReport(req);
        if (!response.status) {
            const result = error(response.error, response.code ? response.code : 500);
            return res.status(response.code ? response.code : 500).json({
                status: response.code ? response.code : 500,
...
module.exports.getNotifications = async (req, res) => {
    try {
        const response = await orderController.getNotifications(req);
        if (!response.status) {
            const result = error(response.error, response.code ? response.code : 500);
            return res.status(response.code ? response.code : 500).json({
                status: response.code ? response.code : 500,
